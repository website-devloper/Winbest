...
<div style="margin-top:-90px;">
    <form style="margin-left: 250px;" method="get" action="{{ route('regus.search') }}">
    @csrf
            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        <div>
                            <h5 class="mb-0">All Regus</h5>
                        </div>
                        <a style="background-color:#00FFFF" href="{{ route('regus.create') }}" class="btn btn-sm mb-0" type="button">+&nbsp; New Regus</a>
                    </div>
                </div>
