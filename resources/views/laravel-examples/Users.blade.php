...
<div>
    <div class="alert alert-secondary mx-4" role="alert">
        <span class="text-white">
            <strong>Add, Edit, Delete  you can use these functional!</strong> This is a
            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <a href="{{ route('users.create') }}" style="background-color: aqua" class="btn btn-sm mb-0" type="button">+&nbsp; New User</a>
                    </div>
                </div>
